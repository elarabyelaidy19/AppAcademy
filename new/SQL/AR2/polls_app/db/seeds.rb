...
User.create!(user_name: 'Megan')
User.create!(user_name: 'Curtis')
User.create!(user_name: 'Jason')

Poll.create!(title: 'Elections 2020', user_id: 1)
Poll.create!(title: 'NBA Season 2019', user_id: 2)
Poll.create!(title: 'Trivia', user_id: 3)

Question.create!(text: 'Who are the two most popular parties in Canada?', poll_id: 1)
Question.create!(text: 'What is the name of Canada\'s current prime minister?', poll_id: 1)
Question.create!(text: 'In what month does voting begin?', poll_id: 1)
Question.create!(text: 'Who is the best basketball player', poll_id: 2)
Question.create!(text: 'What team won the 2019 NBA finals?', poll_id: 2)
Question.create!(text: 'Which country has the largest population in the world?', poll_id: 3)
Question.create!(text: 'What is the name of the best coding bootcamp?', poll_id: 3)
